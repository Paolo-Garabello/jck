import{d,$ as u,y as h,b as a,e as t,x as s,A as r,F as v,Z as f,o as n,a0 as g,l as x,g as b}from"../modules/vue-BNkoxSqV.js";import{u as k,h as y,c as m,b as N}from"../index-oshRG3ZJ.js";import{N as w}from"./NoteDisplay-w2cdiC9E.js";import"../modules/shiki-B7STecTN.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},j={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){const{slides:p,total:_}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
